void main() {
  ...
  // print(suratPins);
  Map SecondMap = Map.from(suratPins);
  // print(SecondMap);
  Map checkModificationMap = Map.unmodifiable({'one': 1, 'two': 2});
  print(checkModificationMap);
  // checkModificationMap['three'] = 3; //unModify

  SecondMap.forEach((key, value) {
    // print('$key : $value');
  });

  var shorting1 = SecondMap.keys.toList()..sort();
  // print(shorting1);
  // print(SecondMap['Amroli']);
  final shorting2 = Map.fromEntries(suratPins.entries.toList()
    ..sort((e1, e2) => e1.value.compareTo(e2.value)));
  // print(shorting2);

  shorting2.forEach((key, value) {
    print("--> " '$key:\n\tPin code :$value\n');
  });
}
