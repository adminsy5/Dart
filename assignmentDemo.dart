...
void totalAvgList() {
  ...
  print("enter the marks of Internet of things : ");
  int? iot = int.parse(stdin.readLineSync()!);

  print("enter the marks of Information system : ");
  int? is1 = int.parse(stdin.readLineSync()!);

  print("enter the marks of Java Programming : ");
  int? java = int.parse(stdin.readLineSync()!);

  print("enter the marks of .net Programming : ");
  int? dotnet = int.parse(stdin.readLineSync()!);

  var mySubjectsMarks = [android, iot, is1, java, dotnet];
  print("\nYour list is : ${mySubjectsMarks}");
  int sum = 0;
  mySubjectsMarks.forEach((element) => sum += element);
  print("Total Marks  : \t${sum}");
  print("Avg of Marks : \t${sum / mySubjectsMarks.length}\n");
}

void sumOfNaturalNumbers() {
  print("How many numbers of sum you want ?");
  int? value = int.parse(stdin.readLineSync()!);
  int sum = 0;
  for (int i = 1; i <= value; i++) {
    sum += i;
  }
  print("sum of 0 to ${value} : $sum");
}

void userInput() {
  print("How much user want to add ?");
  int? value = int.parse(stdin.readLineSync()!);
  for (int i = 0; i < value; i++) {
    print("\nEnter Your Name :");
    String? name = stdin.readLineSync();

    print("\nHey ${name}, please enter your email !");
    String? email = stdin.readLineSync();

    print(
        "\nThank You ${name} , For giving your mail . Kindley can you provide also your number !");
